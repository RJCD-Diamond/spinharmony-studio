...
def test_known_names_map_to_matplotlib():
...
def test_heat_is_a_custom_black_red_yellow_white_ramp():
...
def test_parses_scatty_scale_file(tmp_path):
...
def test_rejects_degenerate_or_missing(tmp_path):
